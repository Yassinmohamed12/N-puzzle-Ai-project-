...
class PuzzleSolverGUI:
    ...
    def __init__(self, master):
        ...
        self.board_values_var = tk.StringVar(value="1 0 3 5 2 6 4 7 8")  # Default board values
        self.board = None
        self.full_path = None
    ...
    def animate_color_change(self):
        ...
        self.master.after(500, self.update_color)
    ...
    def start_solver(self):
        ...
        if(self.board != None):
            ...
            if self.full_path != -1:
                self.print_path()
                self.current_state = self.board.getNumOfSteps()
                if self.isStopped:
    ...
    def next_state(self):
        if self.current_state != None:
            if self.current_state < self.board.getNumOfSteps():
